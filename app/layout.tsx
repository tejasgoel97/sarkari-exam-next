...
export const metadata: Metadata = {
  ...
  title: {
    default: "Sarkari Exam Info | सरकारी रिजल्ट, नई नौकरी और एडमिट कार्ड",
    template: "%s | Sarkari Exam Info",
  },
  description:
    "Sarkari Exam Info पर देखें लेटेस्ट सरकारी नौकरी, सरकारी रिजल्ट, एडमिट कार्ड और आंसर की की जानकारी हिंदी में।",
  keywords: [
    "Sarkari Result",
    "Sarkari Exam",
    "Government Jobs",
        ...
        <footer className="bg-gray-900 text-gray-300 border-t border-gray-800 mt-auto font-hindi">
          ...
          <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div>
                <h3 className="text-white text-lg font-bold mb-4">
                  सोशल मीडिया से जुड़ें
                </h3>
                <p className="text-xs text-gray-400 mb-4">
                  सभी अपडेट्स सबसे पहले अपने फ़ोन पर पाएं।
                </p>
          ...
          <div className="bg-gray-800 py-8 border-t border-gray-700">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <h3 className="text-lg font-bold text-white mb-3">
                सरकारी एग्जाम इन्फो (Sarkari Exam Info) के बारे में
              </h3>
              <p className="text-sm text-gray-400 leading-7 text-justify">
                <strong>Sarkari Exam Info</strong> एक प्रमुख जॉब पोर्टल है जो
                भारतीय युवाओं को <strong>सरकारी नौकरी (Sarkari Naukri)</strong>{" "}
                की जानकारी हिंदी में उपलब्ध कराता है। यहाँ आप केंद्र और राज्य
                सरकार द्वारा जारी की गई नई भर्तियों, रेलवे जॉब्स (Railway Jobs),
                ...
                सरकारी योजनाओं और रोजगार समाचार के लिए Sarkari Exam Info पर
                विजिट करते रहें।
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-950 py-4">
            <div className="max-w-7xl mx-auto px-4 text-center text-sm text-gray-500">
              <p>
                © {new Date().getFullYear()} Sarkari Exam Info. सर्वाधिकार
                सुरक्षित।
              </p>
